...
const blogPosts = [
  ...
  },
  {
    ...
    title: "Top essential Trends in 2021",
    description: "More of this less hello samlande lied much over tightly circa horse taped mightly",
    imgSrc: "/image/Leatest blog2.png",
  },
  {
    id: 3,
    author: "SaberAli",
    ...
    title: "Top essential Trends in 2021",
    description: "More of this less hello samlande lied much over tightly circa horse taped mightly",
    imgSrc: "/image/Leatest blog3.png",
  },
];
        ...
        {blogPosts.map((post) => (
          ...
          >
            ...
            <div className="mt-4">
              ...
              <button className="text-blue-500 hover:text-pink-500 transition-colors underline mt-4">Read More</button>
            </div>
          </div>
        ))}
      </div>
